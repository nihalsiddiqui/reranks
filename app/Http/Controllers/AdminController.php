...
class AdminController extends Controller
{
	...
	public function __construct(AdminSettings $settings)
	{
        ...
        $this->middleware('permission:maintenance-create',['only'=>['maintenanceMode']]);
        $this->middleware('permission:billing-create',['only'=>['billingStore']]);
        $this->middleware('permission:email-create',['only'=>['emailSettings']]);
        $this->middleware('permission:storage-create',['only'=>['storage']]);
        $this->middleware('permission:theme-create',['only'=>['theme','themeStore']]);
        $this->middleware('permission:CSS/JS-create',['only'=>['customCssJs']]);
        $this->middleware('permission:Posts-list',['only'=>['posts']]);
        $this->middleware('permission:Posts-delete',['only'=>['deletePost']]);
        $this->middleware('permission:subscriptions-list',['only'=>['subscriptions']]);
        $this->middleware('permission:transactions-list',['only'=>['transactions']]);
        $this->middleware('permission:transactions-delete',['only'=>['cancelTransaction']]);
        ...
        $this->middleware('permission:blog-list',['only'=>['blog']]);
