...
@section('content')
<div class=" jumbotron-cover-user  m-0 position-relative"
     style="background: #505050 @if ($user->cover != '') url('{{Helper::getFile(config('path.cover').$user->cover)}}') no-repeat center center; background-size: cover; @endif">
...
{{--          </div><!-- avatar-wrap -->--}}
          ...
          <div class="media-body">
            <h4 class="text-capitalize" style="margin-top: 109px;">
              {{$user->hide_name == 'yes' ? $group->username : $group->name}}
