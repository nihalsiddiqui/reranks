        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('/') }}"><i
                                class="glyphicon glyphicon-home myicon-right"></i> {{ trans('admin.view_site') }}</a>
                    </li>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('settings/page') }}"
                                       class="btn btn-default btn-flat">{{ trans('general.edit_my_page') }}</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('logout') }}"
                                       class="btn btn-default btn-flat">{{ trans('users.logout') }}</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="{{ Helper::getFile(config('path.avatar').auth()->user()->avatar) }}" class="img-circle"
                         alt="User Image"/>
                </div>
                <div class="pull-left info">
                    <p class="text-overflow">{{ Auth::user()->name }}</p>
                    <small class="btn-block text-overflow"><a href="javascript:void(0);"><i
                                class="fa fa-circle text-success"></i> {{ trans('general.online') }}</a></small>
                </div>
            </div>
          ...
          <ul class="sidebar-menu">
           ...
           <!-- Links -->
            ...
            <ul class="sidebar-menu">
                ...
                <!-- Links -->
                <li @if(Request::is('panel/admin')) class="active" @endif>
                    <a href="{{ url('panel/admin') }}"><i class="iconmoon icon-Speedometter myicon-right"></i>
                ...
                <li @if (Request::is('panel/admin/deposits')) class="active" @endif>
                    <a href="{{ url('panel/admin/deposits') }}"><i class="fa fa-money-bill-alt"></i>
                        <span>{{ trans('general.deposits') }}
                            @if(App\Models\Deposits::where('status','pending')->count() != 0) <span
                ...
                @canany(array('role-create', 'role-list'))
                    ...
                    <li class="treeview @if( Request::is('panel/admin/create/role') || Request::is('panel/admin/all/roles') ) active @endif">
                        <a href="{{ url('panel/admin/maintenance/mode') }}"><i class="fa fa-user"></i>
                            <span>{{ trans('admin.role') }}</span></a>
                        <ul class="treeview-menu">
                            @can('role-create')

                                <li @if(Request::is('panel/admin/create/role')) class="active" @endif><a
                                        href="{{ url('panel/admin/create/role') }}"><i class="fas fa fa-angle-right"></i>Add
                                        Role</a></li>
                            @endcan
                            @can('role-list')
                                <li @if(Request::is('panel/admin/all/roles')) class="active" @endif><a
                                        href="{{ url('panel/admin/all/roles') }}"><i
                                            class="fas fa fa-angle-right"></i>All Role</a></li>
                            @endcan
            ...
            <!-- Links -->
                ...
                <li @if(Request::is('panel/admin/verification/members')) class="active" @endif>
                    <a href="{{ url('panel/admin/verification/members') }}"><i
                        ...
                        <span>{{ trans('admin.verification_requests') }} @if(VerificationRequests::where('status','pending')->count() != 0)
                                <span
